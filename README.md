...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kvtzxnk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kvtzxnk.containers.anotherwebservice.com/
...
```
git clone git@github.com:udit-001/container-kvtzxnk.git
cd container-kvtzxnk
```
...
```
docker attach container-kvtzxnk
```
